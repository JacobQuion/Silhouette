...
public class SweepCmd extends Command {
    ...
    public SweepCmd(Arm arm, Turret turret) {
        this.arm = arm;
        this.turret = turret;
    ...
    public void initialize() {
        System.out.println("SweepCmd Online");
        stepStartTime = Timer.getFPGATimestamp();
    }

    @Override
    public void execute() {
        SmartDashboard.putString("SweepCmd State", commandState.toString());
    ...
    public void end(boolean interrupted) {
        commandState = CommandState.ZERO_ROUTINE;
        System.out.println("SweepCmd Offline");
    }
