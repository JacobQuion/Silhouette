...
public class TurretFollowerCmd extends Command {
    ...
    public TurretFollowerCmd(Arm arm, Turret turret) {
        this.arm = arm;
        this.turret = turret;
    ...
    public void initialize() {
        System.out.println("TurretFollowerCmd Online");
        stepStartTime = Timer.getFPGATimestamp();
    }

    @Override
    public void execute() {
        SmartDashboard.putString("TurretFollowerCmd State", commandState.toString());
    ...
    public void end(boolean interrupted) {
        commandState = CommandState.ZERO_ROUTINE;
        System.out.println("TurretFollowerCmd Offline");
    }
